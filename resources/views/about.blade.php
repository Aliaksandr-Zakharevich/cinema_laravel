    ...
    <section class="section">
        <div class="container">
            <div class="row">
                <!-- section title -->
                <div class="col-12">
                    <h2 class="section__title"><b>Cinema</b> – Best Place for Movies</h2>
                </div>
                <!-- end section title -->

                <!-- section text -->
                <div class="col-12">
                    <p class="section__text">It is a long <b>established</b> fact that a reader will be distracted by
                    ...
                    <p class="section__text section__text--last-with-margin">'Content here, content here', making it
                        look like <a href="#">readable</a> English. Many desktop publishing packages and web page
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="feature">
                        ...
                        <p class="feature__text">If you are going to use a passage of Lorem Ipsum, you need to be sure
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="feature">
                        ...
                        <p class="feature__text">All the Lorem Ipsum generators on the Internet tend to repeat
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="feature">
                        ...
                        <p class="feature__text">It to make a type specimen book. It has survived not only five
